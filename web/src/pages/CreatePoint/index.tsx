...
const CreatePoint = () => {
    ...
    const [initialPosition, setInitialPosition] = useState<[number, number]>([-23.5653115, -46.6411145]); //Localização inicial: São Paulo para casos onde não tenha permissão de acessar a localização.
